  ...
  class HistoryDoExamsController < ApplicationController
    ...
    def create
      ...
      while counter < y
        ...
        counter += 1
        history1 = HistoryDoExam.create(answer: answer, user_id: current_user.id, question_id: id,
                                        amount_test: max_amount)
      end
      user_exam = UserExam.create(user_id: current_user.id, exam_id: @exam.id, total_score: is_true,
